...
export function getTransactionById(
  ...
  const query = db.prepare(
    "SELECT id, name, amount, description, date, type, recurring_frequency, recurring_day, recurring_month, recurring_interval, user_id, account_id, category_id FROM transactions WHERE id = ? AND user_id = ?",
  );
