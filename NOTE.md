...
Phase 2 — Transactions API (the actual budgeting part)
Phase 3 — Categories and recurring transactions
Phase 4 — Offline support and sync
Phase 5 — Caching and cleanup jobs
